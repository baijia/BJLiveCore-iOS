 ...
 */
- (nullable __kindof BJLMediaUser *)userWithID:(nullable NSString *)userID number:(nullable NSString *)userNumber;
...
/** 用户希望被全屏显示
 ...
 #param user 对象用户
 */
- (BJLObservable)playingUserWantsShowInFullScreen:(BJLMediaUser *)user;
